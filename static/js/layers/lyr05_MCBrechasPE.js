...
function style_MCBrechasPESJL_5_0(feature) {
    return style_MCBrechasPESJL_5_0_str(feature.properties['gridcode']);
}

// Función de estilo basada en valor directo
function style_MCBrechasPESJL_5_0_str(value) {
    const colors = {
...
(function() {
    ...
    div.id = 'lyr05';
    div.innerHTML = '<h4>Mapa de Calor Brechas de Atención PE</h4>';

    // Iterar sobre las categorías y generar etiquetas de la leyenda
    for (var i = 0; i < categories.length; i++) {
        var style = style_MCBrechasPESJL_5_0_str(categories[i]);
        labels.push(
